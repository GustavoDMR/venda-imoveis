...
cd_faixa INTEGER NOT NULL IDENTITY(1,1),
...
cd_cidade INTEGER NOT NULL PRIMARY KEY Identity(1,1),
...
cd_bairro INTEGER NOT NULL PRIMARY KEY IDENTITY(1,1),
...
cd_comprador INTEGER NOT NULL PRIMARY KEY IDENTITY(1,1),
...
cd_vendedor INTEGER NOT NULL PRIMARY KEY IDENTITY(1,1),
...
cd_imovel INTEGER IDENTITY(1,1) PRIMARY KEY,
nm_endereco VARCHAR(100) NOT NULL,
...
cd_oferta INTEGER  PRIMARY KEY IDENTITY(1,1),
